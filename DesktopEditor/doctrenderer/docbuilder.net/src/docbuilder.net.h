...
namespace docbuilder_net
{
	...
	public:
		...
		/// <summary>
		/// Runs the OMNIDOC Document Builder executable. If you do not want to write a .Net application,
		...
		/// </summary>
		/// <param name="path"> The path to the OMNIDOC Document Builder executable. </param>
		/// <returns> True if the operation is successful. </returns>
		...
		/// <summary> Returns the OMNIDOC Document Builder engine version. </summary>
		String^ GetVersion();
