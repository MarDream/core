...
namespace NSDoctRenderer
{
	...
	/**
	 * Base class used by OMNIDOC Document Builder for the document file (text document, spreadsheet, presentation, form document, PDF) to be generated.
	 */
	...
	public:
		...
		/**
		 * Closes the file to stop working with it. You can use a single OMNIDOC Document Builder instance
		...
		/**
		 * Runs the OMNIDOC Document Builder executable. If you do not want to write a C++ application,
		 ...
		 * @param path The path to the OMNIDOC Document Builder executable.
		 * @return True if the operation is successful
		 */
		 ...
		 * i.e. either as an additional property when running OMNIDOC Document Builder executable file or as a part of program code, but not included into the document file script.
		...
		/**
		 * Returns the OMNIDOC Document Builder engine version.
		 * @return The OMNIDOC Document Builder engine version
		 */
		char* GetVersion();
	...
	public:
		/**
		 * Initializes the OMNIDOC Document Builder as a library for the application to be able to work with it.
		...
		/**
		 * Unloads the OMNIDOC Document Builder from the application memory when it is no longer needed.
	...
	/**
	 * Attention!!!
	 * If you use OMNIDOC Document Builder as both an application and a script, then you need to know some rules and limitations:
	 *
	 * 1) To run OMNIDOC Document Builder executable in the C++ application, use the CDocBuilder.Run method in the following way:
	 ...
	 * add it as an additional property when running OMNIDOC Document Builder executable file or as a part of program JavaScript code,
	 * but not included into the document file script.
	 * Sets the --argument property to CDocBuilder.Run:
	 * docbuilder.exe "--argument={\"company\":\"OMNIDOC\",\"product\":\"OMNIDOC Document Builder\"}" "path-to-script.docbuilder"
