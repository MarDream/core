...
#define VER_COMPANYDOMAIN_STR       "www.omnidoc.com\0"
#define ABOUT_COPYRIGHT_STR         VER_LEGALCOPYRIGHT_STR

#define VER_FILEDESCRIPTION_STR     "OMNIDOC Document Builder\0"
...
#define VER_PRODUCTNAME_STR         "OMNIDOC Document Builder\0"
